  ...
  STEP_OUTLINES = {
    ...
    PR: {
      steps: [ {name: "Step 1 - Fill in Application form", instruction: "Please   fill in the application form (永住許可申請書) and upload the form"},
        ...
        {name: "3F - Proof of Pension and Medical Insurance Premiums", instruction: "(1) Proof of payment of pension for past two years, (2) Pension Coverage Regular Notice (Nenkin Teiki Bin) OR Screenshots of Nenkin Net 'Monthly Pension Records' OR National pension insurance premium receipts"},
        {name: "3G - Proof of Assets", instruction: "Please provide copies of (1) your bankbook and (2) Certificate of registerd matters for real estate"},
        ...
        {name: "Proof of Contributions to Japan (if applicable)", instruction: "Please provide any proof of Contributions to Japan"},
