  ...
  STEP_OUTLINES = {
    ...
    PR: {
      steps: [ {name: "Step 1 - Fill in Application form", instruction: "Please   fill in the application form (永住許可申請書) and upload the form"},
        ...
        {name: "Step 3B  - Proof of identity (if a dependent)", instruction: "Provide 1 copy of the following documents: (1) Family Register (Full Version); (2) Birth Certificate; (3) Marriage Cartificate; (4) Certificate of items recorded on acknowledgement notification; (5) Documents supporting (1) - (4) if they cannot be provided. Test Step"},
        ...
        {name: "Step 3G - Proof of Assets", instruction: "Please provide copies of (1) your bankbook; (2) Certificate of registerd matters for real estate"},
